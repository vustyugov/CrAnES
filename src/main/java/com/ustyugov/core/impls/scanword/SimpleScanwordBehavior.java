...
import com.ustyugov.core.interfaces.ScanwordBehavior;
import com.ustyugov.core.utils.ArrowUtil;
 ...
 */
public class SimpleScanwordBehavior implements ScanwordBehavior {
    ...
    public void selectArrowInCommentCell (int row, int column, String link){
        ...
        ArrowUtil.createLinkBetweenCommentCellAndActiveCell(commentCell, activeCell, link, linkInActiveCell);
    }
